...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(global) {\n\n/*global window, global*/\n\nvar root = typeof window !== 'undefined' ?\n    window : typeof global !== 'undefined' ?\n    global : {};\n\nmodule.exports = Individual;\n\nfunction Individual(key, value) {\n    if (key in root) {\n        return root[key];\n    }\n\n    root[key] = value;\n\n    return value;\n}\n\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../webpack/buildin/global.js */ \"./node_modules/webpack/buildin/global.js\")))\n\n//# sourceURL=webpack://epoxy/./node_modules/individual/index.js?");
...
"use strict";
eval("\n\nmodule.exports = function isObject(x) {\n\treturn typeof x === \"object\" && x !== null;\n};\n\n\n//# sourceURL=webpack://epoxy/./node_modules/is-object/index.js?");
...
"use strict";
eval("\n\nmodule.exports = SoftSetHook;\n\nfunction SoftSetHook(value) {\n    if (!(this instanceof SoftSetHook)) {\n        return new SoftSetHook(value);\n    }\n\n    this.value = value;\n}\n\nSoftSetHook.prototype.hook = function (node, propertyName) {\n    if (node[propertyName] !== this.value) {\n        node[propertyName] = this.value;\n    }\n};\n\n\n//# sourceURL=webpack://epoxy/./node_modules/virtual-dom/virtual-hyperscript/hooks/soft-set-hook.js?");
...
eval("module.exports = isThunk\r\n\r\nfunction isThunk(t) {\r\n    return t && t.type === \"Thunk\"\r\n}\r\n\n\n//# sourceURL=webpack://epoxy/./node_modules/virtual-dom/vnode/is-thunk.js?");
...
eval("module.exports = isHook\n\nfunction isHook(hook) {\n    return hook &&\n      (typeof hook.hook === \"function\" && !hook.hasOwnProperty(\"hook\") ||\n       typeof hook.unhook === \"function\" && !hook.hasOwnProperty(\"unhook\"))\n}\n\n\n//# sourceURL=webpack://epoxy/./node_modules/virtual-dom/vnode/is-vhook.js?");
...
eval("var version = __webpack_require__(/*! ./version */ \"./node_modules/virtual-dom/vnode/version.js\")\n\nmodule.exports = isVirtualText\n\nfunction isVirtualText(x) {\n    return x && x.type === \"VirtualText\" && x.version === version\n}\n\n\n//# sourceURL=webpack://epoxy/./node_modules/virtual-dom/vnode/is-vtext.js?");
...
eval("module.exports = isWidget\n\nfunction isWidget(w) {\n    return w && w.type === \"Widget\"\n}\n\n\n//# sourceURL=webpack://epoxy/./node_modules/virtual-dom/vnode/is-widget.js?");
...
eval("module.exports = \"2\"\n\n\n//# sourceURL=webpack://epoxy/./node_modules/virtual-dom/vnode/version.js?");
...
eval("var version = __webpack_require__(/*! ./version */ \"./node_modules/virtual-dom/vnode/version.js\")\n\nmodule.exports = VirtualText\n\nfunction VirtualText(text) {\n    this.text = String(text)\n}\n\nVirtualText.prototype.version = version\nVirtualText.prototype.type = \"VirtualText\"\n\n\n//# sourceURL=webpack://epoxy/./node_modules/virtual-dom/vnode/vtext.js?");
...
eval("var isObject = __webpack_require__(/*! is-object */ \"./node_modules/is-object/index.js\")\nvar isHook = __webpack_require__(/*! ../vnode/is-vhook */ \"./node_modules/virtual-dom/vnode/is-vhook.js\")\n\nmodule.exports = diffProps\n\nfunction diffProps(a, b) {\n    var diff\n\n    for (var aKey in a) {\n        if (!(aKey in b)) {\n            diff = diff || {}\n            diff[aKey] = undefined\n        }\n\n        var aValue = a[aKey]\n        var bValue = b[aKey]\n\n        if (aValue === bValue) {\n            continue\n        } else if (isObject(aValue) && isObject(bValue)) {\n            if (getPrototype(bValue) !== getPrototype(aValue)) {\n                diff = diff || {}\n                diff[aKey] = bValue\n            } else if (isHook(bValue)) {\n                 diff = diff || {}\n                 diff[aKey] = bValue\n            } else {\n                var objectDiff = diffProps(aValue, bValue)\n                if (objectDiff) {\n                    diff = diff || {}\n                    diff[aKey] = objectDiff\n                }\n            }\n        } else {\n            diff = diff || {}\n            diff[aKey] = bValue\n        }\n    }\n\n    for (var bKey in b) {\n        if (!(bKey in a)) {\n            diff = diff || {}\n            diff[bKey] = b[bKey]\n        }\n    }\n\n    return diff\n}\n\nfunction getPrototype(value) {\n  if (Object.getPrototypeOf) {\n    return Object.getPrototypeOf(value)\n  } else if (value.__proto__) {\n    return value.__proto__\n  } else if (value.constructor) {\n    return value.constructor.prototype\n  }\n}\n\n\n//# sourceURL=webpack://epoxy/./node_modules/virtual-dom/vtree/diff-props.js?");
...
/*!**********************!*\
  !*** ./src/build.js ***!
  \**********************/
/*! exports provided: Epoxy */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core */ \"./src/core/index.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"Epoxy\", function() { return _core__WEBPACK_IMPORTED_MODULE_0__[\"Epoxy\"]; });\n\n\n\n\n//# sourceURL=webpack://epoxy/./src/build.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Component; });\n/* harmony import */ var virtual_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! virtual-dom */ \"./node_modules/virtual-dom/index.js\");\n/* harmony import */ var virtual_dom__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(virtual_dom__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _Observable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Observable */ \"./src/core/Observable.js\");\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\n\n\n\nvar Component =\n/*#__PURE__*/\nfunction () {\n  _createClass(Component, [{\n    key: \"isRootComponent\",\n    get: function get() {\n      return this._parent == null;\n    }\n  }]);\n\n  function Component(component, renderCallback, parent) {\n    var _this = this;\n\n    _classCallCheck(this, Component);\n\n    _defineProperty(this, \"traverseChildren\", function (tree) {\n      return tree.children.map(function (c) {\n        var idx = _this._components.map(function (x) {\n          return x.name.toUpperCase();\n        }).indexOf(c.tagName);\n\n        if (idx !== -1) {\n          return _this._components[idx].nodeTree; // return this._components[idx].renderFnc(h);\n        }\n\n        return c;\n      });\n    });\n\n    _defineProperty(this, \"initializeChildComponent\", function (name, comp) {\n      return new Component(_objectSpread({}, comp, {\n        name: name\n      }), function (patches) {\n        _this.updateDom();\n      }, _this);\n    });\n\n    _defineProperty(this, \"updateDom\", function (state) {\n      var tree = _this.renderFnc(function (a, b, c) {\n        if (typeof a === 'string') {\n          return Object(virtual_dom__WEBPACK_IMPORTED_MODULE_0__[\"h\"])(a, b, c);\n        } else if (_typeof(a) === 'object') {\n          var cmp = _this._components.find(function (c) {\n            return c.name === a.name;\n          });\n\n          if (cmp) {\n            return cmp.nodeTree;\n          }\n\n          return Object(virtual_dom__WEBPACK_IMPORTED_MODULE_0__[\"h\"])('span', {}, []);\n        }\n      });\n\n      tree.children = _this.traverseChildren(tree);\n      var patches = Object(virtual_dom__WEBPACK_IMPORTED_MODULE_0__[\"diff\"])(_this.nodeTree, tree);\n      _this.nodeTree = tree; // this.rootNode = patch(this.rootNode, patches);\n\n      _this.renderCallback(patches);\n    });\n\n    this.name = component.name;\n    this.renderCallback = renderCallback;\n    this.state = Object(_Observable__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n      target: component.state(),\n      listener: this.updateDom,\n      freeze: false\n    });\n    this._parent = parent;\n\n    var _loop = function _loop(key) {\n      Object.defineProperty(_this, key, {\n        get: function get() {\n          return this.state[key];\n        },\n        set: function set(newVal) {\n          this.state[key] = newVal;\n        },\n        configurable: true\n      });\n    };\n\n    for (var key in this.state) {\n      _loop(key);\n    }\n\n    if (component.init) {\n      component.init.apply(this);\n    }\n\n    this._components = [];\n    this.renderFnc = component.render;\n    this.nodeTree = this.renderFnc(function (a, b, c) {\n      if (typeof a === 'string') {\n        return Object(virtual_dom__WEBPACK_IMPORTED_MODULE_0__[\"h\"])(a, b, c);\n      } else if (_typeof(a) === 'object') {\n        var _c = _this.initializeChildComponent(a.name || String(_this._components.length), a);\n\n        _this._components.push(_c);\n\n        return _c.renderFnc(virtual_dom__WEBPACK_IMPORTED_MODULE_0__[\"h\"]);\n      }\n    });\n\n    if (this.isRootComponent) {\n      this.renderCallback(this.nodeTree);\n      this.updateDom();\n    } // for (let key in component.components) {\n    //   this._components.push(this.initializeChildComponent(key, component.components[key]))\n    // }\n    // this.rootNode = create(this.nodeTree);\n    // document.body.appendChild(this.rootNode);\n\n  }\n\n  return Component;\n}();\n\n\n\n//# sourceURL=webpack://epoxy/./src/core/Component.js?");
...
/*!***************************!*\
  !*** ./src/core/index.js ***!
  \***************************/
/*! exports provided: Epoxy, Component */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Application__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Application */ \"./src/core/Application.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"Epoxy\", function() { return _Application__WEBPACK_IMPORTED_MODULE_0__[\"default\"]; });\n\n/* harmony import */ var _Component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Component */ \"./src/core/Component.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"Component\", function() { return _Component__WEBPACK_IMPORTED_MODULE_1__[\"default\"]; });\n\n\n\n\n\n//# sourceURL=webpack://epoxy/./src/core/index.js?");
...
eval("/* (ignored) */\n\n//# sourceURL=webpack://epoxy/min-document_(ignored)?");
